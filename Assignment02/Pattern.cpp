/*Write a program that prints a box, an oval, an arrow and a diamond as follows. Please keep in
mind that you need to take number of rows and columns input from user.*/
#include<iostream>
using namespace std;
